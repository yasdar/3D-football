...
export class Player extends BaseObj{
    ...
    objectIsReady(): void {
     // console.log('clone player Data',this.cloneData);
      ...
      this.color_part("clothes.003",Shirt_color);
      this.color_part("clothes.001",Shirt_color);
      this.color_part("clothes.002",Shirt_color);
      ...
      this.color_part("skin.001",SKin_color);
         ...
         // console.log("1 @-->",node)
          node.material.forEach((m:any)=>{
            ...
            if(m.name.indexOf(part) != -1){
              ...
              /* console.log("matetial name",m.name);
              let new_color:any = hexToRgb(color);
              console.log("new_color",new_color);
              m.color = new_color;*/
           //   console.log("apply color:",color," to material name:",m.name);
