...
export class Terrain {
 _scene:THREE.Scene;
 private _terrainMesh0:THREE.Mesh;
 private _terrainMesh01:THREE.Mesh;
 ...
 _borderColor:number|null;
 _lineColor:number|null;
 _pitchColor:number|null;
